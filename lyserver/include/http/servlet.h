...
public:
    ...
    virtual int32_t handle(lyserver::http::HttpRequest::ptr request
                   ...
                   , lyserver::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (lyserver::http::HttpRequest::ptr request
                   , lyserver::http::HttpResponse::ptr response
                   , lyserver::http::HttpSession::ptr session)> callback;
...
public:
    ...
    /**
     * @brief 添加模糊匹配servlet
     * @param[in] uri uri 模糊匹配 /lyserver_*
