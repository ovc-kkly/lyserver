...
namespace lyserver
{
    ...
    public:
         ...
         */
        TcpServer(lyserver::IOManager *worker = lyserver::IOManager::GetThis(), lyserver::IOManager *io_woker = lyserver::IOManager::GetThis(), lyserver::IOManager *accept_worker = lyserver::IOManager::GetThis());
